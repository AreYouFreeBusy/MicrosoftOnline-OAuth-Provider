...
namespace Owin.Security.Providers.MicrosoftOnline
{
    ...
    public class MicrosoftOnlineApplyRedirectContext : BaseContext<MicrosoftOnlineAuthenticationOptions>
    {
        /// <summary>
        ...
        public MicrosoftOnlineApplyRedirectContext(IOwinContext context, MicrosoftOnlineAuthenticationOptions options,
